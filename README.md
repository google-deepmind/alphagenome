...
[non-commercial use](https://alphagenome.google/terms) (subject to the terms of
use). Query rates vary based on demand – the pre-computed Atlas predictions will
...
for large scale analyses requiring more than 1 million predictions. Once you
obtain your API key, you can easily get started by following our
...
[AlphaGenome Terms of Service](https://alphagenome.google/terms). Other than as
expressly provided in the AlphaGenome Terms of Service (see references to
...
Atlas are for non-commercial use only and should not be used for the training of
other machine learning models. Predictions are for theoretical modelling and
...
the [Terms of Use](https://alphagenome.google/terms).
